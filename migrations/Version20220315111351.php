...
final class Version20220315111351 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE test DROP linked_study_id');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE test ADD linked_study_id INT DEFAULT NULL, CHANGE name name VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`, CHANGE subject subject VARCHAR(255) NOT NULL COLLATE `utf8mb4_unicode_ci`');
        $this->addSql('ALTER TABLE test ADD CONSTRAINT FK_D87F7E0C89B04D36 FOREIGN KEY (linked_study_id) REFERENCES study (id)');
        $this->addSql('CREATE INDEX IDX_D87F7E0C89B04D36 ON test (linked_study_id)');
    }
}
